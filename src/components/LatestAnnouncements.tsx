...
export const LatestAnnouncements = ({ announcements }: { announcements?: any[] }) => {
  ...
  return (
    // Removi o 'mb-8' e usei um design de 'linha' mais sutil
    <div className="mb-6 animate-in fade-in slide-in-from-top-4 duration-700">
      <div className="bg-[#121417]/30 border-y border-white/5 py-2 overflow-hidden">
        <div className="flex items-center gap-6 whitespace-nowrap">
          ...
          {/* LINK PARA TODOS */}
          <Link href="/announcements" className="ml-auto pr-4 text-[9px] font-black uppercase text-gray-600 hover:text-[#d4af37] transition-colors">
            Full Feed
          </Link>
        </div>
      </div>
